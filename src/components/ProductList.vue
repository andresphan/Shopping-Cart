...
<div class="pro-list row">
 <div v-for="(product,index) in productList " :key="index" class="col-lg-3" ><product-item/><product-i-item @handle-buy="handleBuy" :product="product"></product-i-item></div>
...
<script>
import ProductIItem from './ProductIItem.vue';
...
return {
   productList: [
  {
    ...
    "name": "Bộ Bàn Phím",
    "image": sp1,
    "description": "Phím và chuột có dây dài Phù hợp với nhiều loại hệ điều hành khác nhau, nhiều cấu hình máy của PC hoặc laptop. Đèn Led bắt mắt, phù hợp cho các game thủ chơi Game vào ban đêm Phím giả cơ nghe âm thanh rất thanh và êm Chuột Chuyên Game được thiết kế riêng dành cho game thủ và phòng net",
    "price": 134000,
    "sale": 10,
    "quantityInStock": 10
  },
